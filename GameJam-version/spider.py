...
class Spider(object):
    ...
    def __init__(self):
        ...
        self.img = pygame.image.load("resources/spider.png").convert_alpha()
    ...
    def update(self):
        ...
        if pygame.time.get_ticks() - self.frame_start_time > self.update_speed and (self.vel.magnitude() > 1 or self.pose == 1):
        ...
        if pygame.time.get_ticks() - self.recharge_time > 10:
...
class Egg(object):
    ...
    def __init__(self):
        ...
        self.img = pygame.image.load("resources/eggs.png").convert_alpha()
        self.img_rect = self.img.get_rect()
        
        self.w = self.img_rect.width
        self.h = self.img_rect.height
        
        self.pos = Vector2D(GAME_WIDTH/2.0 + random.randint(-30,30), GAME_HEIGHT/2.0 + random.randint(-30,30)) # center
